...
You can now find the `graph-service` repository within the [AmplicaLabs/gateway](https://github.com/AmplicaLabs/gateway.git) repository at the following path:
